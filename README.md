...
The front end uses the DSI Pin module [[1]] for generating traces (consult the GitHub repository of [DSIbin-inst](https://github.org/uniba-swt/DSIbin-inst) for further information), by performing a dynamic analysis on x86 binary code.
...
6. Setup the Pin module from DSIbin-inst by following the instructions of the supplied [README](https://www.github.org/uniba-swt/DSIbin-inst/README):
...
#### DSIref
Further information regarding the usage of the DSIref component can be found in the [README](https://www.github.org/uniba-swt/DSIbin/resources/tools/README) file at `resources/tools/README`.
